                ...
                <li class="inline-flex items-center">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-400 ml-1 md:ml-2 text-sm font-medium" aria-current="page">Quotes</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">All Quotes</h1>
        </div>
    </x-slot>
                    ...
                    <table class="table-fixed min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-100">
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">{{ $quote->id }}
                                </td>
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900"> {{ date('d/m/Y H:i', strtotime($quote->created_at)) }}</td>
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900"><a href="{{ route('customer-details', ['id' => $quote->customer_id]) }}" class="no-underline hover:underline">{{ $quote->customer_firstname }} {{ $quote->customer_lastname }}</a></td>
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">{{ $quote->status }}</td>
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">@if($quote->currency=="MUR") Rs @else {{$quote->currency}} @endif {{ number_format($quote->amount,2,".",",") }}</td>
                                <td class="p-4 whitespace-nowrap space-x-2">
                                    <a href="{{ route('detail-quote', ['id' => $quote->id]) }}" data-modal-toggle="product-modal" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
