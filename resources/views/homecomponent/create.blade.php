<x-app-layout>
    <x-slot name="header">
        <div class="mx-4 my-4">
            ...
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Create Slide</h1>
        </div>
    </x-slot>
    ...
    <div class="font-sans antialiased">
        <div class="flex flex-col items-center min-h-screen bg-gray-100 sm:justify-center sm:pt-0">
            <div class="w-full overflow-hidden bg-white">
                ...
                <form method="POST"  id="upload_form_create" action="{{ route('store-slider') }}" enctype="multipart/form-data">
                      @csrf
