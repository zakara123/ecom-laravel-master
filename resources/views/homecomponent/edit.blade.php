    ...
    <x-slot name="header">
        <div class="mx-4 my-4">
            ...
            <div class="block sm:flex items-center">
                <div class="w-1/2">
                    <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Update Slides</h1>
                </div>
            </div>
        </div>
    </x-slot>
        ...
        <div class="flex flex-col items-center min-h-screen bg-gray-100 sm:justify-center sm:pt-0">
            ...
            <div class="w-full overflow-hidden bg-white">
                ...
                <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                    <form method="POST" id="upload_form" action="{{ route('update_slider', $homeCarousel->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#upload_form").submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('update_slider', $homeCarousel->id) }}",
                    type: 'POST',
                    data: fd,
                    dataType: 'JSON',
                    contentType: false,
