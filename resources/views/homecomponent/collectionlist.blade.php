                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-400 ml-1 md:ml-2 text-sm font-medium"
                                  aria-current="page">Collections</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">All HomePage Collection - {{$mainComponent->title}}</h1>
        </div>
    </x-slot>
        ...
        <div class="mb-1 w-full">
            <div class="block sm:flex items-center md:divide-x md:divide-gray-100">
                ...
                <div class="flex items-center sm:justify-end w-full">
                    ...
                    <a href=" {{ route('createcollection', $id)}}"
                        ...
                        @foreach ($homeCarousels as $homeCarousel)
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="p-4 whitespace-nowrap space-x-2">
                                    <a href="{{ route('edit_collection', $homeCarousel->id) }}"
                                    ...
                                    <form action="{{ route('destroy_collection',$homeCarousel->id) }}" method="POST"
