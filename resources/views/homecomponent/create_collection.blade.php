                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ url('homepage-components') }}"
                               class="text-gray-700 hover:text-gray-900 ml-1 md:ml-2 text-sm font-medium">Homepage Component Collection</a>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Create Collection</h1>
        </div>
    </x-slot>
        ...
        <div class="flex flex-col items-center min-h-screen bg-gray-100 sm:justify-center sm:pt-0">
            <div class="w-full overflow-hidden bg-white">
                <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                    <form method="POST" id="upload_form_create" action="{{ route('store-collection') }}" enctype="multipart/form-data">
                    @csrf
                        <!-- Title -->
                        <div class="mb-6">
                            ...
                            <input type="hidden" name="slider_id" id="slider_id" value="{{$id}}">
                            <input
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-6">
                                ...
                                <input id="filepond" class="filepond" type="file" name="image" accept="image/*"  />
                                @error('image')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">{{ $message }}</span></p>
                                @enderror
                            </div>
