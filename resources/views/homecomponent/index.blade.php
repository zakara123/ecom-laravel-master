...
<x-app-layout>
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-400 ml-1 md:ml-2 text-sm font-medium"
                                  aria-current="page">Homepage Component</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">All HomePage Component</h1>
        </div>
    </x-slot>
            ...
            <div class="block sm:flex items-center md:divide-x md:divide-gray-100">
                ...
                <div class="flex items-center sm:justify-end w-full">
                    <div class="hidden md:flex pl-2 space-x-1">
                        <a href="javascript:void(0)" data-modal-toggle="add-interval-homecarousel"
                    ...
                    <a href="javascript:void(0)" data-modal-toggle="add-slider-homepage"
                        ...
                        @foreach ($homeCarousels as $homeCarousel)
                            <tr class="hover:bg-gray-100">
                                ...
                                @if($homeCarousel->type == 'slider')
                                    <a href="{{ route('slider_list', $homeCarousel->id) }}"
                                ...
                                @endif
                                @if($homeCarousel->type == 'collection')
                                    <a href="{{ route('collection_list', $homeCarousel->id) }}"
                                       class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                        <svg class="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                @endif
                                    <form action="{{ route('destroy_component',$homeCarousel->id) }}" method="POST"
    ...
    <div class="overflow-x-hidden overflow-y-auto fixed top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center h-modal sm:h-full hidden"
         id="add-interval-homecarousel" aria-hidden="true">
            ...
            <div class="bg-white rounded-lg shadow relative">
                ...
                <div class="flex items-start justify-between p-5 border-b rounded-t">
                    <h3 class="text-xl font-semibold">
                        Homecarousel Items Interval
                    </h3>
                    <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center"
                            data-modal-toggle="add-interval-homecarousel">
                ...
                <form method="POST" class="p-5" action="{{ route('homecarousels-interval') }}" enctype="multipart/form-data">
                    @csrf

                    @if($interval)
                        <input type="hidden" name="id" id="id_homecarousel_interval" value="{{ $interval->id }}">
                    @endif
                    ...
                    <div class="mb-6">
                        ...
                        <input required
                            ...
                            type="number" name="interval" placeholder="Ex: 3000" min="0" step="1" @if($interval) value="{{old('interval',$interval->value)}}" @endif>
                    </div>
    ...
    <div class="overflow-x-hidden overflow-y-auto fixed top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center h-modal sm:h-full hidden"
         id="add-slider-homepage" aria-hidden="true">
        <div class="relative w-full max-w-2xl px-4 h-full md:h-auto">
            ...
            <div class="bg-white rounded-lg shadow relative">
                ...
                <div class="flex items-start justify-between p-5 border-b rounded-t">
                    ...
                    <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center"
                            data-modal-toggle="add-slider-homepage">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                  d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                  clip-rule="evenodd"></path>
                ...
                <form method="POST" class="p-5" action="{{ route('homecomponent-slider') }}" enctype="multipart/form-data">
                    @csrf
