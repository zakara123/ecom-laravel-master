    ...
    <x-slot name="header">
        <div class="mx-4 my-4">
            ...
            <div class="block sm:flex items-center">
                <div class="w-1/2">
                    <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Update Company</h1>
                </div>
            </div>
        </div>
    </x-slot>
                    ...
                    @method('PUT')
                        ...
                        <div class="mb-6">
                            ...
                            <input required
                                   ...
                                   type="text" name="company_name" placeholder="Company Name" value="{{old('name',@$company->company_name)}}">
                            @error('company_name')
                        ...
                        <div class="mb-6">
                            ...
                            <input required
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                   type="text" name="company_address" placeholder="company_address" value="{{old('company_address',$company->company_address)}}">
                        ...
                        <div class="mb-6">
                            ...
                            <input required
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                   type="text" name="brn_number" placeholder="BRN Number" value="{{old('brn_number',$company->brn_number)}}">
                            @error('brn_number')
                            <span class="text-red-600 text-sm">
                                {{ $message }}
                            </span>
                        ...
                        <div class="mb-6">
                            ...
                            <input
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                   type="text" name="vat_number" placeholder="VAT Number" value="{{old('vat_number',$company->vat_number)}}">
                            @error('vat_number')
                            <span class="text-red-600 text-sm">
                                {{ $message }}
                            </span>
                        ...
                        <div class="mb-6">
                            ...
                            <input required
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                   type="email" name="company_email" placeholder="Contact Email for General Queries" value="{{old('company_email',$company->company_email)}}">
                            @error('company_email')
                            <span class="text-red-600 text-sm">
                                {{ $message }}
                            </span>
                        ...
                        <div class="mb-6">
                            ...
                            <input
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    type="email" name="order_email" placeholder="Order Email for Sales" value="{{old('order_email',$company->order_email)}}">
                            @error('order_email')
                            <span class="text-red-600 text-sm">
                                {{ $message }}
                            </span>
                        ...
                        <div class="mb-6">
                            ...
                            <input required
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                   type="tel" name="company_phone" placeholder="Contact Phone" value="{{old('company_phone',$company->company_phone)}}">
                            @error('company_phone')
                            <span class="text-red-600 text-sm">
                                {{ $message }}
                            </span>
                        ...
                        <div class="mb-6">
                            ...
                            <input
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    type="text" name="company_fax" placeholder="Contact FAX" value="{{old('company_fax',$company->company_fax)}}">
                            @error('company_fax')
                            <span class="text-red-600 text-sm">
                                {{ $message }}
                            </span>
                        ...
                        <div class="mb-6">
                            ...
                            <input
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    type="tel" name="whatsapp_number" placeholder="Whatsapp Number" value="{{old('whatsapp_number',$company->whatsapp_number)}}">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-6 mt-6 flex items-center w-full">
                                        <div class=" card tex-white bg-secondary mb-3">
                                            <div class="card-bod">
                                                <img src="{{ @$company->logo }}" class="card-img-top object-contain hover:object-scale-down  w-48" alt="{{ @$company->company_name }}">
                                            </div>
                                        </div>
                            </div>
                            @error('company_logo')
