    ...
    <x-slot name="header">
        <div class="mx-4 my-4">
            ...
            <div class="block sm:flex items-center">
                <div class="w-1/2">
                    <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Add New Page</h1>
                </div>
            </div>
        </div>
    </x-slot>
        ...
        <div class="flex flex-col items-center bg-gray-100 sm:justify-center sm:pt-0">
            <div class="w-full bg-white">
                <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                    <form id="upload_form" method="POST" action="{{ route('page.store') }}"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="content" 
                                      ...
                                      placeholder="Your description..."> {{ old('content') }}</textarea>
                            @error('content')
                            <span class="text-red-600 text-sm">
                                    {{ $message }}
                                </span>
