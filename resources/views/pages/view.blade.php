...
@section('content')
    <div class=""style="flex-grow:1">
        <section class=" py-1">
            <div class="main-page-content container mx-auto mt-4 px-5 mx-auto sm:px-4 md:px-14 lg:px-14 xl:px-14 2xl:px-14" style="margin-top:-3px">
                <div class="text-center text-xl mb-4" style="background: #F7F5F1" >{{ $page->title }}
                <div class="text-md min-h-max decription" style="background: #F7F5F1">
                    {!! $page->content !!}
                </div>
            </div>
            </div>
