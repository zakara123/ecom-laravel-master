                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-400 ml-1 md:ml-2 text-sm font-medium"
                                  aria-current="page">Collection Image Carousel</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">All Home Page Collection Images List</h1>
        </div>
    </x-slot>
        ...
        <div class="mb-1 w-full">
            <div class="block sm:flex items-center md:divide-x md:divide-gray-100">
                ...
                <div class="flex items-center sm:justify-end w-full">
                    ...
                    <a href="{{ route('home-collection-image.create')}}"
                ...
                <div class="shadow overflow-hidden">
                    <table class="table-fixed min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                         @foreach ($homepageCollectionImages as $homeCarousel)
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="p-4 whitespace-nowrap space-x-2">
                                    <a href="{{ route('home-collection-image.edit', $homeCarousel->id) }}"
                                    ...
                                    <form action="{{ route('home-collection-image.destroy',$homeCarousel->id) }}" method="POST"
                    ...
                    <div class="text-center align-center">
                        {{ $homepageCollectionImages->links("pagination::tailwind") }}
                    </div>
                </div>
            </div>
        </div>
