    ...
    <x-slot name="header">
        <div class="mx-4 my-4">
            ...
            <div class="block sm:flex items-center">
                <div class="w-1/2">
                    <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Update Homepage Collection Image </h1>
                </div>
            </div>
        </div>
    </x-slot>
        ...
        <div class="flex flex-col items-center min-h-screen bg-gray-100 sm:justify-center sm:pt-0">
            ...
            <div class="w-full overflow-hidden bg-white">
                ...
                <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                    <form method="POST" action="{{ route('home-collection-image.update', $homepageCollectionImage->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6">
                        ...
                        <input
                               ...
                               type="text" name="title" placeholder="Title" value="{{ old('title', $homepageCollectionImage->title) }}">
                        @error('title')
                    ...
                    <div class="mb-6">
                        ...
                        <input
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                               type="text" name="link" placeholder="Link" value="{{ old('link', $homepageCollectionImage->link) }}">
                        @error('link')
                        <span class="text-red-600 text-sm">
                            {{ $message }}
                        </span>
                    ...
                    <div class="mb-6">
                        ...
                        placeholder="Your description..." >{{ old('description', $homepageCollectionImage->description) }}</textarea>
                    ...
                    <div class="mb-6">
                        ...
                        <input
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                               type="number" name="width" placeholder="Width" value="{{ old('width', $homepageCollectionImage->width) }}">
                        @error('width')
                        <span class="text-red-600 text-sm">
                            {{ $message }}
                        </span>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-6 mt-6 flex items-center w-full">
                                        <div class=" card tex-white bg-secondary mb-3">
                                            <div class="card-bod">
                                                <img src="{{ $homepageCollectionImage->image }}" class="card-img-top object-contain hover:object-scale-down  w-48" alt="{{ $homepageCollectionImage->title }}">
                                            </div>
                                        </div>
                            </div>
                            @error('image')
