    ...
    <div class="w-full flex gap-4">
        ...
        <div class="w-4/5 bg-gray-200">
            ...
            <div class="w-full overflow-hidden bg-white">
                <h1 class="text-xl sm:text-2xl font-semibold text-gray-900 p-5">View Past Medication</h1>
                <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                            ...
                            <div class="grid md:grid-cols-3  md:gap-6">
                                <div class="mb-6 mr-2 w-full">
                                    ...
                                    <p>{{$record->medication_drug_name}}</p>
                                ...
                                <div class="mb-6 mr-2 w-full">
                                    ...
                                    <p>{{$record->medication_dda_drug}}</p>
                                </div>
                                <div class="mb-6 mr-2 w-full">
                                    <label class="block text-sm font-medium text-gray-700" for="name">
                                        Dosage
                                    </label>
                                    <p>{{$record->medication_dosage}}</p>                                    
                                </div>
                                <div class="mb-6 mr-2 w-full">
                                    <label class="block text-sm font-medium text-gray-700" for="name">
                                        Frequency Of Use
                                    </label>   
                                    <p>{{$record->medication_frequency_of_use}}</p>                                 
                                ...
                                <div class="mb-6 mr-2 w-full">
                                    ...
                                    <p>{{$record->medication_started_on}}</p>                                 
                                ...
                                <div class="mb-6 mr-2 w-full">
                                    ...
                                    <p>{{$record->medication_reason_for_taking}}</p>   
                                </div>
                                ...
                                <div class="mb-6 mr-2 w-full">
                                    ...
                                    <p>{{$record->medication_side_effects}}</p>   
                                ...
                                <div class="mb-6 mr-2 w-full">
                                    ...
                                    <p>{{$record->medication_used_until}}</p>
                                </div>
                                ...
                                <div class="mb-6 mr-2 w-full">
                                    ...
                                    <p>{{$record->medication_discontinued_note}}</p>
                                ...
                                <div class="mb-6 mr-2 w-full">
                                    ...
                                    <p>{{$record->medication_reason_discontinued}}</p>
                                </div>
