        ...
        <div class="p-2 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
            ...
            <div class="mb-1 w-full">
                <div class="block sm:flex items-center md:divide-x md:divide-gray-100">
                    ...
                    <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Family History</h1>
                        <a href="{{ route('add-patient-family-history', $customer->id) }}" 
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="p-4  text-center font-medium text-gray-900">{{ $item->relation }}
                                </td>
                                <td class="p-4  text-center font-medium text-gray-900">{{ $item->condition }}</td>
                                <td class="p-4  text-center font-medium text-gray-900">{{ $item->created_at }}</td>

                                <td class="p-4  space-x-2">                                
                                    <a href="{{ route('edit-patient-family-history', [$customer->id,$item->id]) }}"
                                    ...
                                    <a href="{{ route('view-patient-family-history', [$customer->id,$item->id]) }}"
                                        class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
