    ...
    <div class="w-full flex gap-4">
        ...
        <div class="w-4/5 bg-gray-200">
            ...
            <div class="w-full overflow-hidden bg-white">
                <h1 class="text-xl sm:text-2xl font-semibold text-gray-900 p-5">Add Implanted Device</h1>
                <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                    <form method="POST" action="{{ route('save-patient-implanted-devices', $customer->id) }}"  enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="grid md:grid-cols-2  md:gap-6">
                                <div class="mb-6 mr-2 w-full">
                                    ...
                                    <input
                                        ...
                                        type="date" name="date_of_implanted" required placeholder="Implanted On" value="{{old('date_of_implanted')}}">
                                ...
                                <div class="mb-6 mr-2 w-full">
                                    ...
                                    <input
                                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                        type="text" name="name" required placeholder="Name" value="{{old('name')}}">
                                            @error('name')
                                            <span class="text-red-600 text-sm">
                                                {{ $message }}
                                            </span>
                            ...
                            <div class="grid md:grid-cols-1  md:gap-6">
                                ...
                                <div class="mb-12 mr-2 w-full">
                                    ...
                                    <textarea
                                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                        name="location_on_body" placeholder="Location On Body" value="{{old('location_on_body')}}"></textarea>
