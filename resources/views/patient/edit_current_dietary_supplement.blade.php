    ...
    <div class="w-full flex gap-4">
        ...
        <div class="w-4/5 bg-gray-200">
            ...
            <div class="w-full overflow-hidden bg-white">
                <h1 class="text-xl sm:text-2xl font-semibold text-gray-900 p-5">Edit Current Dietary Supplement</h1>
                <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                    <form method="POST" action="{{ route('edit-save-patient-dietary-supplements', [$customer->id,$record->id]) }}"  enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="grid md:grid-cols-3  md:gap-6">
                                <div class="mb-6 mr-2 w-full">
                                    ...
                                    <input
                                        ...
                                        type="text" name="medication_drug_name" required placeholder="Drug Name" value="{{old('medication_drug_name',$record->medication_drug_name)}}">
                                ...
                                <div class="mb-6 mr-2 w-full">
                                    ...
                                    <textarea
                                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                        name="medication_note" placeholder="Medication Note" value="">{{old('medication_note',$record->medication_note)}}</textarea>
