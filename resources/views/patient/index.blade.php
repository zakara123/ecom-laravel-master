<x-app-layout>
    <x-slot name="header">
        <div class="mx-4 my-4">
            ...
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">All Patients</h1>
        </div>
    </x-slot>
        ...
        <div class="mb-1 w-full">
            <div class="block sm:flex items-center md:divide-x md:divide-gray-100">
                <div class="mt-1 relative flex gap-2 sm:w-64 xl:w-96">
                    <div class="flex justify-center">
                        <div class="mb-3 xl:w-96">
                            <form class="sm:pr-3 mb-4 sm:mb-0" id="form_search" action="javascript:void(0)" data-action="{{ route('search-patients') }}" method="GET">
                ...
                <div class="flex items-center sm:justify-end w-full">
                    ...
                    <!--<a href="{{ route('import-customer-view') }}"
                    ...
                    <table class="table-fixed min-w-full w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="p-4  text-center font-medium text-gray-900">{{ $customer->upi }}
                                </td>
                                <td class="p-4  text-center font-medium text-gray-900">{{ $customer->firstname }}</td>
                                <td class="p-4  text-center font-medium text-gray-900">{{ $customer->lastname }}</td>
                                <td class="p-4  text-center font-medium text-gray-900">{{ $customer->sex }}</td>
                                <td class="p-4  text-center font-medium text-gray-900">{{ $customer->email }}</td>
                                <td class="p-4  text-center font-medium text-gray-900">{{ $customer->phone }}</td>

                                <td class="p-4  space-x-2">
                                <a href="{{ route('patient-details', $customer->id) }}"
                                        class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                        
                                        Appointments
                                    </a>
                                    @if( $customer->is_default == "no")
                                    <a href="{{ route('medical-record', $customer->id) }}"
                                        class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                    ...
                                    <!--<form action="{{ route('patients.destroy', $customer->id) }}" method="POST" onsubmit="return confirm('{{ trans('You will delete, do you confirm?') }}');" style="margin:0">
