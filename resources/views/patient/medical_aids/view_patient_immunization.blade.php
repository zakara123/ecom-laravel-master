    ...
    <div class="w-full flex gap-4">
        ...
        <div class="w-4/5 bg-gray-200">
            ...
            <div class="w-full overflow-hidden bg-white">
                <h1 class="text-xl sm:text-2xl font-semibold text-gray-900 p-5">View Medical Aids</h1>
                <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                        ...
                        <div class="grid md:grid-cols-2  md:gap-6">
                                <div class="mb-6 mr-2 w-full">
                                    ...
                                    {{ $record->presc_glasses == 1 ? 'Yes' : 'No' }}
                                </div>
                                <div class="mb-6 mr-2 w-full">
                                    <label class="block text-sm font-medium text-gray-700" for="name">
                                        Hearing Aids
                                    </label>
                                    {{ $record->hearing_aids == 1 ? 'Yes' : 'No' }}
                            ...
                            <div class="grid md:grid-cols-3  md:gap-6">
                                ...
                                <div class="mb-6 mr-2 w-full">
                                    ...
                                    <p>{{ $record->prosthesis == 1 ? 'Yes' : 'No' }}</p>
