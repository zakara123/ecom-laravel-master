    ...
    <x-slot name="header">
        <div class="mx-4 my-4">
            ...
            <div class="block sm:flex items-center">
                <div class="w-1/2">
                    <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Update Carousel</h1>
                </div>
            </div>
        </div>
    </x-slot>
        ...
        <div class="flex flex-col items-center min-h-screen bg-gray-100 sm:justify-center sm:pt-0">
            ...
            <div class="w-full overflow-hidden bg-white">
                ...
                <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                    <form method="POST" action="{{ route('homecarousel.update', $homeCarousel->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-6 mt-6 flex items-center w-full">
                                        <div class=" card tex-white bg-secondary mb-3">
                                            <div class="card-bod">
                                                <img src="{{ $homeCarousel->image }}" class="card-img-top object-contain hover:object-scale-down  w-48" alt="{{ $homeCarousel->title }}">
                                            </div>
                                        </div>
                            </div>
                            @error('image')
