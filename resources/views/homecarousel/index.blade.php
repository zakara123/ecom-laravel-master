                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-400 ml-1 md:ml-2 text-sm font-medium"
                                  aria-current="page">Homepage Carousel</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">All Carousel</h1>
        </div>
    </x-slot>
        ...
        <div class="mb-1 w-full">
            <div class="block sm:flex items-center md:divide-x md:divide-gray-100">
                ...
                <div class="flex items-center sm:justify-end w-full">
                    ...
                    <a href="{{ route('homecarousel.create')}}"
                        ...
                        @foreach ($homeCarousels as $homeCarousel)
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="p-4 whitespace-nowrap space-x-2">
                                    <a href="{{ route('homecarousel.edit', $homeCarousel->id) }}"
                                    ...
                                    <form action="{{ route('homecarousel.destroy',$homeCarousel->id) }}" method="POST"
