                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ url('homecarousel') }}"
                               class="text-gray-700 hover:text-gray-900 ml-1 md:ml-2 text-sm font-medium">Homepage Carousel</a>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Create Carousel</h1>
        </div>
    </x-slot>
        ...
        <div class="flex flex-col items-center min-h-screen bg-gray-100 sm:justify-center sm:pt-0">
            <div class="w-full overflow-hidden bg-white">
                <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                    <form method="POST" action="{{ route('homecarousel.index') }}" enctype="multipart/form-data">
                    @csrf
                        <!-- Title -->
                        <div class="mb-6">
