                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ url('petty_cash') }}"
                               class="text-gray-700 hover:text-gray-900 ml-1 md:ml-2 text-sm font-medium">Petty Cash</a>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Update Transaction</h1>
        </div>
    </x-slot>
        ...
        <div class="flex flex-col items-center bg-gray-100 sm:justify-center sm:pt-0">
            <div class="w-full overflow-hidden bg-white">
                <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                    <form id="upload_form" method="POST" action="{{ route('petty_cash.update', $pettyCash->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="">
                                ...
                                <div class="relative block">
                                    ...
                                    <input name="date" required
                                           ...
                                           datepicker-autohide
                                           type="text"
                                           value="{{old('date',date('d/m/Y', strtotime($pettyCash->date)))}}"
                        ...
                        <div class="mb-6">
                            <div class="">
                                ...
                                <select name="typeOfMoney" required
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Money In/Out" value="{{old('ledger_account')}}">

                                        <option value="MoneyIn" @if($pettyCash->debit) selected @endif>Money In</option>
                                        <option value="MoneyOut" @if($pettyCash->credit) selected @endif>Money Out</option>
                        ...
                        <div class="mb-6">
                            <div class="">
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="ledger_account">
                                    Ledger/Account :
                                </label>
                                ...
                                <select name="ledger_account" required
                                    ...
                                    @foreach($ledgers as $lg)
                                        <option value="{{ $lg->id }}" @if($pettyCash->ledger_account == $lg->id) selected @endif>{{ $lg->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description"
                                      ...
                                      placeholder="Your description..." > {{old('description',$pettyCash->description)}}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <input
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                type="number" name="amount" placeholder="Amount" min="0" step=".01" value="{{old('amount',abs($pettyCash->amount))}}">
                            @error('amount')
                            <span class="text-red-600 text-sm">
                                {{ $message }}
                            </span>
