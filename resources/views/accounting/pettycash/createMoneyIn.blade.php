<x-app-layout>
    <x-slot name="header">
        <div class="mx-4 my-4">
            ...
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Add new Transaction</h1>
        </div>
    </x-slot>
        ...
        <div class="flex flex-col items-center bg-gray-100 sm:justify-center sm:pt-0">
            <div class="w-full overflow-hidden bg-white">
                <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                    <form method="POST" action="{{ route('petty_cash.index') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="mb-6">
                            <div class="">
                                ...
                                <div class="relative block">
                                    ...
                                    <input name="date" required datepicker="" datepicker-format="dd/mm/yyyy" datepicker-autohide type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                                </div>
                            </div>
                            @error('date')
