    ...
    <x-slot name="header">
        <div class="mx-4 my-4">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ url('ledger') }}"
                               class="text-gray-700 hover:text-gray-900 ml-1 md:ml-2 text-sm font-medium">Ledger</a>
                        </div>
                    </li>
            ...
            <div class="block sm:flex items-center">
                <div class="w-1/2">
                    <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Update Ledger</h1>
                </div>
            </div>
        </div>
    </x-slot>
                    ...
                    @method('PUT')
                        ...
                        <div class="mb-6">
                            ...
                            <input required
                                   ...
                                   type="text" name="name" placeholder="Name" value="{{old('name',$ledger->name)}}">
                            @error('name')
                        ...
                        <div class="mb-6">
                            ...
                            <select name="id_ledger_group" type="text" required
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Ledger Group" value="{{old('id_ledger_group',$ledger->id_ledger_group)}}">
                                <option value="Parent">No Parent</option>
                                @foreach($ledgerGroups as $lg)
                                <option value="{{ $lg->id }}" @if($lg->id == $ledger->id_ledger_group) selected @endif>{{ $lg->name }}</option>
                                @endforeach
                            </select>
