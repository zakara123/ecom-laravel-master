<x-app-layout>
    <x-slot name="header">
        <div class="mx-4 my-4">
            ...
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">All Suppliers</h1>
        </div>
    </x-slot>
                    ...
                    <table class="table-fixed min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-100">
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">{{ $supplier->id }}
                                </td>
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">{{ $supplier->name }}</td>
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">{{ $supplier->name_person }}</td>
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">{{ $supplier->address }}</td>
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">{{ $supplier->order_email }}</td>
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">{{ $supplier->mobile }}</td>

                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">{{ date('d/m/Y H:i', strtotime($supplier->created_at)) }}</td>
                                <td class="p-4 whitespace-nowrap space-x-2">
                                    ...
                                    <form action="{{ route('supplier.destroy', $supplier->id) }}" method="POST" onsubmit="return confirm('{{ trans('You will delete, do you confirm?') }}');" style="margin:0">
