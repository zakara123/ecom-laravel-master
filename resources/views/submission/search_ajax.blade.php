                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($sales as $sale)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">{{ $sale->customer_firstname }} {{ $sale->customer_lastname }}</td>
                                    <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900"><?php if($sale->rental_start_date){ echo date("d/m/y", strtotime($sale->rental_start_date));}?></td>
