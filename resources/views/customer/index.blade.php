<x-app-layout>
    <x-slot name="header">
        <div class="mx-4 my-4">
            ...
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">All Customers</h1>
        </div>
    </x-slot>
                ...
                <div class="mt-1 relative flex gap-2 sm:w-64 xl:w-96">
                    <div class="flex justify-center">
                        <div class="mb-3 xl:w-96">
                            <form class="sm:pr-3 mb-4 sm:mb-0" id="form_search" action="javascript:void(0)" data-action="{{ route('search-customers') }}" method="GET">
                    ...
                    <table class="table-fixed min-w-full w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-100">
                                <td class="p-4  text-center font-medium text-gray-900">{{ $customer->id }}
                                </td>
                                <td class="p-4  text-center font-medium text-gray-900">{{ $customer->company_name }}</td>
                                <td class="p-4  text-center font-medium text-gray-900">{{ $customer->firstname }} {{ $customer->lastname }}</td>
                                ...
                                <td class="p-4  text-center font-medium text-gray-900">{{ date('d/m/Y H:i', strtotime($customer->created_at)) }}</td>
                                <td class="p-4  space-x-2">
                                    <a href="{{ route('customer-details', $customer->id) }}"
                                        class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                        <svg class="mr-2 text-white" width="20" height="20" x="0px" y="0px" viewBox="0 0 1000 1000" fill="currentColor" stroke="currentColor">
