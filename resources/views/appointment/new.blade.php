            ...
            <div class="max-w-full mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="mx-auto my-2">
                        ...
                        <div class="w-full mt-4">
                            <input type="submit" name="add_sale" id="add_sale" value="Send (Pending)" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 cursor-pointer rounded">
                            </input>
                            <input type="submit" name="add_sale" id="add_sale_paid" value="Send (Paid)" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 cursor-pointer rounded">
                            </input>
                        </div>
                    </div>
                </div>
