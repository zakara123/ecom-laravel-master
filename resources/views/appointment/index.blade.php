<x-app-layout>
    ...
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
        ...
        <div class="mb-1 w-full">
            <form class="sm:pr-3 mb-4 sm:mb-0" id="form_search" action="javascript:void(0)" data-action="{{ route('appointment-search') }}" method="GET">
                    ...
                    <table class="table-fixed min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-100">
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900"><a href="{{ route('detail-appointment', ['id' => $sale->id]) }}" class="no-underline hover:underline">{{ $sale->id }}</a>
                                </td>
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900"> {{ date('d/m/Y H:i', strtotime($sale->created_at)) }}</td>
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900"><a href="{{ route('patient-details', ['id' => $sale->customer_id]) }}" class="no-underline hover:underline">{{ $sale->patient_firstname }} {{ $sale->patient_lastname }}</a></td>
                                ...
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">{{ ucfirst(strtolower($sale->status)) }}</td>
                                <td class="p-4 whitespace-nowrap space-x-2">
                                    ...
                                    @if(Auth::check() &&  Auth::User()->role=='admin' && $sale->status == "BOOKED")
                                    <form action="{{ route('destroy_appointment',$sale->id) }}" method="POST"
