    ...
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
        ...
        <div class="mb-1 w-full">
            <form class="sm:pr-3 mb-4 sm:mb-0" id="form_search" action="javascript:void(0)"
                data-action="{{ route('search-sales') }}" method="GET">
                <div class="block sm:flex items-center md:divide-x md:divide-gray-100">
                    ...
                    <div class="flex items-center sm:justify-end w-full">
                        ...
                        <a href="#" class="text-gray-500 hover:text-gray-900 cursor-pointer p-1 hover:bg-gray-100 rounded inline-flex justify-center">
                            ...
                            <a href="{{ route('import-sales-view') }}"
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($sales as $sale)
                                <tr class="hover:bg-gray-100">
                                    <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900"><a
                                            href="{{ route('detail-sale', ['id' => $sale->id]) }}"
                                            class="no-underline hover:underline">{{ $sale->id }}</a>
                                    </td>
                                    <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">
                                        {{ date('d/m/Y H:i', strtotime($sale->created_at)) }}</td>
                                    <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">
                                        {{ $sale->payment_method }}</td>
                                    <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900"><a
                                            href="{{ route('customer-details', ['id' => $sale->customer_id]) }}"
                                            class="no-underline hover:underline">{{ $sale->customer_firstname }}
                                            {{ $sale->customer_lastname }}</a></td>
                                    <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">
                                        {{ $sale->status }}</td>
                                    <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">
                                        ...
                                        @else
                                            {{ $sale->currency }}
                                        @endif {{ number_format($sale->amount, 2, '.', ',') }}
                                    </td>
                                    <td class="p-4 whitespace-nowrap space-x-2">
                                        <a href="{{ route('detail-sale', ['id' => $sale->id]) }}"
