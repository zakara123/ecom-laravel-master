                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-400 ml-1 md:ml-2 text-sm font-medium"
                                aria-current="page">Doctors</span>
                        </div>
                    </li>
                </ol>
            </nav>
                    ...
                    <table class="table-fixed min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">{{ $user->first_name }} {{ $user->last_name }}</td>
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">{{ $user->specialities }}</td>
                                ...
                                <td class="p-4 whitespace-nowrap space-x-2">
                                    ...
                                    <form action="{{ route('doctor.destroy',$user->id) }}" method="POST" onsubmit="return confirm('{{ trans('You will delete, do you confirm?') }}');" style="margin:0">
