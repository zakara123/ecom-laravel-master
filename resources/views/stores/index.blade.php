                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-400 ml-1 md:ml-2 text-sm font-medium"
                                  aria-current="page">Store</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">All Stores</h1>
        </div>
    </x-slot>
...
{{--                                    {{ $store->pickup_location }}--}}
                                    <label for="disabled-toggle1" class="inline-flex relative items-center cursor-pointer">
                                        <input type="checkbox" value="" @if ($store->pickup_location == 'yes') checked
                                               @endif id="disabled-toggle1" name="is_online" class="sr-only peer"disabled >
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                        <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">@if ($store->pickup_location == 'yes') Yes @else No @endif</span>
                                    </label>
                                </td>
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">
{{--                                    {{$store->is_online }}--}}
                                    <label for="disabled-toggle2" class="inline-flex relative items-center cursor-pointer" disabled>
                                        <input type="checkbox" value="" @if ($store->is_online == 'yes') checked
                                               @endif id="disabled-toggle2" name="is_online" class="sr-only peer"  disabled>
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                        <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">@if ($store->is_online == 'yes') Yes @else No @endif</span>
                                    </label>
                                </td>
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">
{{--                                    {{$store->is_default }}--}}
                                    <label for="disabled-toggle3" class="inline-flex relative items-center cursor-pointer" disabled>
                                        <input type="checkbox" value="" @if ($store->is_default == 'yes') checked
                                               @endif id="disabled-toggle3" name="is_online" class="sr-only peer" disabled>
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                        <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">@if ($store->is_online == 'yes') Yes @else No @endif</span>
                                    </label>
                                </td>
                                ...
                                <td class="p-4 whitespace-nowrap text-center font-medium text-gray-900">
                                    ...
                                    {{ date('d/m/Y H:i', strtotime($store->created_at)) }}
                                </td>

                                <td class="p-4 whitespace-nowrap space-x-2">
                                    <a href="{{ route('stores.edit', $store->id) }}" data-modal-toggle="product-modal"
