<x-app-layout>
    <x-slot name="header">
        <div class="mx-4 my-4">
            ...
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Create Store</h1>
        </div>
    </x-slot>
        ...
        <div class="flex flex-col items-center bg-gray-100 sm:justify-center sm:pt-0">
            <div class="w-full overflow-hidden bg-white">
                <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                    <form method="POST" action="{{ route('stores.index') }}" enctype="multipart/form-data">
                    @csrf
                    <!-- Name -->
                        <div class="mb-6">
                            ...
                            <input required
                                   ...
                                   type="text" name="name" placeholder="Stores" value="">
                            @error('name')
                        ...
                        <div class="mb-6">
                            ...
                            <label for="default-toggle1" class="inline-flex relative items-center cursor-pointer">
                                <input type="checkbox" value="" checked
                                       id="default-toggle1" name="pickup_location" class="sr-only peer" >
...
{{--                                    VAT TYPE--}}
{{--                            </label>--}}
{{--                            <select name="vat_type" type="text" required--}}
{{--                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"--}}
{{--                                 placeholder="VAT" value="{{old('vat_type')}}">--}}
{{--                                <option value="No VAT">No VAT</option>--}}
{{--                                <option value="Added to the price">Added to the price</option>--}}
{{--                                <option value="Included in the price">Included in the price</option>--}}
{{--                            </select>--}}
{{--                            @error('vat_type')--}}
{{--                            <span class="text-red-600 text-sm">--}}
{{--                                {{ $message }}--}}
