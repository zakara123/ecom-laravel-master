...
<body
    class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal"style="display:flex;flex-direction:column;max-width:1800px; margin:auto;min-height:100vh;">
    ...
    <div class="d"style="flex-grow:1">
        <div class="container mx-auto mt-4 px-5 mx-auto sm:px-4 md:px-14 lg:px-14 xl:px-14 2xl:px-14">
            ...
            <form id="your-form-id" action="{{ route('add-appointment-request') }}" method="POST">
                @csrf
                <!-- Stepper Content -->
                <div class="mt-4">
                    <!-- Step 1 -->
                    ...
                    <div id="step-3" class="step hidden">
                        <p class="text-xl-p mb-2">Please select your preferred date and time for the appointment. A
                    ...
                    <div id="step-5" class="step hidden">
                        ...
                        <div id="on-site-fields" class="hidden">
                            <h2 class="text-xl mb-2">Select where consultation will take place</h2>
                            <div class="grid gap-4 mb-4 grid-cols-2">
                                <div class="mb-6">
                                    <label class="inline-flex items-center">
        ...
        function updateStepHeading(step) {
            ...
            switch (step) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    heading.innerText = 'Appointment Date and Time';
                    break;
                case 4:
        ...
        function updateStepper(step) {
            ...
            stepIndicators.forEach((indicator, index) => {
                if (index + 1 < step) {
                    ...
                    indicator.classList.remove('bg-gray-100', 'text-gray-600');
