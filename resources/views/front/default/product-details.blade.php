                ...
                <div class="container px-5 pt-8 mx-auto sm:px-4 md:px-12 lg:px-12 xl:px-12 2xl:px-12">
                    <div class="lg:w-full mx-auto flex flex-wrap">
                        <div class="lg:w-2/3 pswp-gallery my-gallery" style="cursor: zoom-in;" id="forcedgallery">
                            <div
                                ...
                                @if (count($images) >= 1 || count($variationImages) >= 1)
                                    <div class="container thumbnail-img-block thumb_div_img mx-auto space-y-2 lg:space-y-0">
                                        @php $i = 1 @endphp
                                        @foreach ($images as $image)
                                            <div class="thumb-image btn_photoswipe_img w-full rounded hover:opacity-90 hover:shadow-xl @if ($i == 1) active @endif main-thumb-image"
                            ...
                            <div class="product__main_photos_mobile w-full hidden_desktop">
                                @if (count($images) <= 0)
                                    <div class="cover-item relative btn_photoswipe active" id="cover-item" data-swipe="1">
                                        <img alt="{{ $product->name }}" class="object-cover object-center w-full "
                                            @if (!empty($image_cover) > 0) src="{{ $image_cover->src }}"
                                             @else
                                                 @if (isset($company->logo) && !empty(@$company->logo))
                        ...
                        <div class="lg:w-1/3 w-full desc-table lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div class="leading-relaxed decription desc-table">{!! $product->description !!}</div>
