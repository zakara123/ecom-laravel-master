    ...
    <div class=""style="flex-grow:1">
        <section class=" py-1">
            <div class="container mx-auto flex items-center flex-wrap pt-4">
                <nav id="category" class="w-full z-30 top-0 px-6 py-1" style="margin-left: 16px">
                ...
                @if ($theme == 'troketia')
                <div class="grid  sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3  gap-2 lg:gap-12 w-full relative z-40 "
                    id="no_filter_product_list" style="margin-bottom:60px; margin-left:3px">
                    @foreach ($products as $product)
                        <div
                            class="bg-white  bg-contrast-lower min-h-64 flex justify-center items-center relative p-2 item_product_filter ">
                            <div class="flex  gap-1.5 lg:gap-2 flex-wrap justify-center " style="height: 420px">
                                <div class="flex flex-col ">
                                    <div class="flex-shrink-0" style="width: 405px">
                                                ...
                                                <img 
                                                    ...
                                                    @else 
                                                        @if (isset($company->logo) && !empty(@$company->logo)) 
                                                            src="{{ @$company->logo }}" 
                                                        @else 
                                                            src="{{ asset('front/img/ECOM_L.png') }}" 
                                                        @endif 
                                                    @endif
                                                >
                                            </a>
                                        ...
                                        <a href="{{ route('product', ['id' => $product->slug]) }}" >
                                            <div class="pt-3 flex items-center justify-between cursor-pointer " style="background: #f6f6f6">
                                                ...
                                                @if (str_contains(request()->getSchemeAndHttpHost(), 'bata'))
                                                    ...
                                                    @endif
                                                @else
                                                    <p class="text-gray-900 " style="background: #f6f6f6"> {{ Str::limit($product->name, 60, '...') }} </p>
                                        ...
                                        @else
                                            <p class="pt-1 text-gray-900 font-sizes " style="background: #f6f6f6; font-size:15px">Rs
                ...
                <div class="grid  sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3  gap-2 lg:gap-3 w-full relative z-40 "
                    id="no_filter_product_list" style="margin-left: 100px;margin-right:100px;margin-bottom:60px;">
                    @foreach ($products as $product)
                        <div
        ...
        <div id="pagination" class="text-center" style="padding-bottom:40px">
