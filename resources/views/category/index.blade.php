    ...
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
        ...
        <div class="mb-1 w-full">
            <div class="block sm:flex items-center md:divide-x md:divide-gray-100">
                <form class="sm:pr-3 mb-4 sm:mb-0" action="javascript:void(0)" method="GET">
                    ...
                    <table class="table-fixed min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-100">
                                <td class="p-4 whitespace-nowrap text-center  font-medium text-gray-900">{{ $category->id }}</td>
                                <td class="p-4 whitespace-nowrap text-center  font-medium text-gray-900">{{ $category->category }}</td>
                                <td class="p-4 whitespace-nowrap text-center  font-medium text-gray-900">{{ $category->slug }}</td>
                                ...
                                <td class="p-4 whitespace-nowrap space-x-2">
                                    ...
                                    <form action="{{ route('category.destroy',$category->id) }}" method="POST" onsubmit="return confirm('{{ trans('You will delete, do you confirm?') }}');" style="margin:0">
