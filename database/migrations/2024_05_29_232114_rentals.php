...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('rentals', function (Blueprint $table) {
            ...
            $table->double('amount')->nullable(true)->default(0);
            ...
            $table->enum('type_sale', array('Online Sales','New Sales Page'))->nullable(false);
